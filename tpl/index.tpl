...
<body style="background:#464646;">
	<div class="auto w1300 m10" id="top">
        <div id="count" class="right" style="margin-right:20px;margin-top:10px;cursor:pointer;"><img src="/images/count.png" /></div>
		<div id="up" class="right" style="margin-top:10px;cursor:pointer;"><img src="/images/up.png" /></div>
        <div class="clear"></div>
	</div>
